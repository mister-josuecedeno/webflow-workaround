...
function SubmitForm(page, success) {
    ...
    const data = { request: { formTemplateId: 'c82f92c8-60c6-4f60-bf12-a043bae0b7a7', submittedById: urlVars["sId"], submittedByType: urlVars["sType"], parentId: urlVars["pId"], parentType: urlVars["pType"], source: urlVars["source"], data: submitData } };
...
function ApplyTagsOnClick() {
    const urlVars = GetUrlVars();
    const data = { request: { formTemplateId: 'c82f92c8-60c6-4f60-bf12-a043bae0b7a7', companyId: '02fb34c6-0e7a-409b-b564-c88b36db60ae', parentId: urlVars["pId"], parentType: urlVars["pType"] } };
...
sa.form.init.push(InitializeCharacterCounters);function InitializeChecklistField()
{
...
sa.form.init.push(InitializeChecklistField);var saFormUploads = saFormUploads || { Pending: [] };
